...
- [ ] 2.1 (P) Build the Attack Vector Registry
...
- [ ] 2.2 (P) Build the Session State Machine
...
- [ ] 3.1 (P) Implement the LLM Gateway adapter
...
- [ ] 3.2 (P) Implement the Game Event Publisher
...
- [ ] 3.3 (P) Implement repository adapters for game data persistence
...
- [ ] 4.1 Implement Game Service for session lifecycle
...
- [ ] 4.2 (P) Implement Evaluation Service for LLM outcome classification
...
- [ ] 4.3 Implement Round Service for the turn loop
...
- [ ] 4.5 (P) Implement Summary Service
...
- [ ] 5.1 Implement REST controllers for session and summary endpoints
...
- [ ] 5.2 (P) Configure CORS policy and input validation limits
...
- [ ] 6.1 Configure WebSocket infrastructure and player identity validation
...
- [ ] 6.2 Implement the Game Message Handler
...
- [ ] 7.1 (P) Implement the WebSocket Client service
...
- [ ] 7.2 (P) Implement the Game Context and state reducer
...
- [ ] 8.2 (P) Build the Jailbreaker game panel
...
- [ ] 8.3 (P) Build the Guardian game panel
...
- [ ] 9.1 Wire frontend and backend together for the full game flow
...
- [ ] 9.2 Implement LLM failure handling and graceful degradation
...
- [ ] 9.3 Expose health monitoring and validate security settings
...
- [ ] 10.1 (P) Write unit tests for domain and application logic
...
- [ ] 10.2 (P) Write integration tests for application and infrastructure layers
...
- [ ] 10.3 Write end-to-end tests for complete game scenarios
